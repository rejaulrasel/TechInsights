            ...
            <ModalBody>
              <div className="flex flex-col py-4 items-center justify-center space-y-4">
                ...
                <h6 className="text-center text-sm font-medium opacity-70">
                  {deletionState === "danger"
                    ? "If you delete your article once, all data related to this article will be permanently deleted and can never be recovered!"
                    : deletionState === "loading"
                      ? "Article is being deleted. Please wait"
                      : deletionState === "success"
                        ? "Article has been completely deleted from the database"
        ...
        {fromProfile && currentUser?._id === data?.author?._id && (
          <CardFooter className="">
            <div className="flex gap-4">
              <Link href={`/articles/edit/${data.author.username}/${data._id}`}>
