            ...
            <div className="sticky top-20">
                ...
                <Card className="mb-2">
                  <CardBody>
                    ...
                    <p className="text-small text-default-500">
                      Neela in Psychology of Workplaces
                    </p>
                  </CardBody>
                </Card>
                <Card className="mb-2">
                  <CardBody>
                    <h4 className="font-semibold">
                      Why I Stopped Boycotting Businesses and Cutting People Off
                      Because of Their Political Views
                    </h4>
                    <p className="text-small text-default-500">
                      Alisa Wolf in Human Parts
                    </p>
                  </CardBody>
                </Card>
                <Card className="mb-2">
              ...
              <SidebarSection title="Who to follow">
                <div className="space-y-4">
                  {["Jane Doe", "John Smith", "Alice Johnson"].map(
                    (name, index) => (
                      <div
                        key={index}
