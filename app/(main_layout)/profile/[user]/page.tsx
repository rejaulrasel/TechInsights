            ...
            <div className="lg:order-2 lg:col-span-1 order-1">
              ...
              {isWonProfile ? (
                ...
                <Button
                  ...
                  size="sm"
                  variant="flat"
                  onClick={() => handleUnfollow(profile?._id as string)}
                >
                  Unfollow
                </Button>
              ) : (
                <Button
                  ...
                  variant="flat"
                  onClick={() =>
                    handleFollowNewPerson(profile as IUserResponse)
                  }
                >
                  Follow
                </Button>
              ...
              {isWonProfile ? (
                <div className="mt-8">
                  <div className="">
                    ...
                    {profile?.following
                      ?.slice(0, flowFlngDisplay)
                      ?.reverse()
                      ?.map((following: IfollowersAndFollowing, indx) => (
                        <div
                          key={indx}
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <div className="text-sm">
                              <UserName
                                isPremium={following?.isPremiumMember}
                                name={following?.name}
                              />
                  ...
                  {profile?.following && profile?.following?.length > 5 && (
                    <button
                      ...
                      onClick={() =>
                        setFlowFlngDisplay(
                          flowFlngDisplay > 5 ? 5 : profile.following.length
                        )
                      }
                    >
                      {flowFlngDisplay > 5
                ...
                <div className="mt-8">
                  <div className="">
                    ...
                    {profile?.followers
                      ?.slice(0, flowFlngDisplay)
                      ?.reverse()
                      ?.map((follower: IfollowersAndFollowing, indx) => (
                        <div
                          key={indx}
                          className="flex items-center justify-between mb-4"
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <div className="text-sm">
                              <UserName
                                isPremium={follower?.isPremiumMember}
                                name={follower?.name}
                              />
                              <p className=" text-gray-600 text-sm">
                                @{follower?.username}
                  ...
                  {profile?.followers && profile?.followers?.length > 5 && (
                    <button
                      ...
                      onClick={() =>
                        setFlowFlngDisplay(
                          flowFlngDisplay > 5 ? 5 : profile.followers.length
                        )
                      }
                    >
                      {flowFlngDisplay > 5
