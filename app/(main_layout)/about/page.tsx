      ...
      <motion.div className="mb-12" variants={fadeInRight}>
        ...
        <div className="space-y-4">
          <p>
            ...
            landscape. We are committed to bridging the gap between emerging
            technologies and real-world application, offering our community the
          ...
          <p>
            ...
            community-driven growth, we seek to cultivate the next generation of
            software leaders and innovators.
          </p>
        </div>
      </motion.div>
